          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                us at support@ThriftKaro.com with your order number and a
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                support@ThriftKaro.com, or by calling us at (+91) 916-715-3770
                between the hours of 9am and 5pm IST, Monday to Friday.
              </p>
            </div>
          )}
        </div>
